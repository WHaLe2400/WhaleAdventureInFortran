...
!      LOGICAL hasind,refel,TOUT,mfig,eng
      LOGICAL hasind,refel,TOUT,eng    !20120613Modify by CY
      COMMON /LOGCL/ hasind,refel,TOUT(3),mfig,eng
C 
C  INITIALIZE ONCE. 
C 
      OPEN (18,FILE='plotout',STATUS='unknown',FORM='formatted')     !好像无用的文件
      OPEN (5,FILE='cap.in')      !20120613Add by CY
      OPEN (6,FILE='cap.out')     !20120613Add by CY
      WRITE(6,2)
2     FORMAT(/,' ****************************************************',
     & '*********************************')
      WRITE(6,3)
